...
<body>
    ...
    <div class="page-controls">
      ...
      <button type="button" id="theme-settings-btn" class="theme-settings-btn" aria-expanded="false" aria-controls="theme-panel" aria-label="Choose theme" title="Theme">theme</button>
      <button type="button" id="data-source-btn" class="data-source-btn" aria-expanded="false" aria-controls="data-panel" aria-label="Data source" title="Data">data</button>
    </div>
