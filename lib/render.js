...
function renderPage(mdPath, { assetPrefix = '' } = {}) {
  ...
  sidebarHtml += `</div>
    ...
    <div class="sidebar-controls">
      ...
      <button type="button" id="theme-settings-btn" class="theme-settings-btn" aria-expanded="false" aria-controls="theme-panel" aria-label="Theme settings" title="Themes">
